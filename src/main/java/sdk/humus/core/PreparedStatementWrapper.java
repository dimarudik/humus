...
public class PreparedStatementWrapper extends StatementWrapper implements PreparedStatement {
    ...
    protected final List<ProxyPlugin> plugins;

    public PreparedStatementWrapper(PreparedStatement target, List<ProxyPlugin> plugins, String sql) {
    ...
    private <R> R execute(String methodName, JdbcCallable<PreparedStatement, R> terminal, Object[] args)
            throws SQLException {
    ...
    public boolean execute() throws SQLException {
        return execute("execute", (t, a) -> t.execute(), new Object[] {this.sql});
    }

    @Override
    public ResultSet executeQuery() throws SQLException {
        return execute("executeQuery", (t, a) -> t.executeQuery(), new Object[] {this.sql});
    }

    @Override
    public int executeUpdate() throws SQLException {
        return execute("executeUpdate", (t, a) -> t.executeUpdate(), new Object[] {this.sql});
    }
