...
public class StatementWrapper implements Statement {
    ...
    public StatementWrapper(Statement target, List<ProxyPlugin> plugins, String sql) {
        this.target = target;
    ...
    public boolean execute(String sql) throws SQLException {
        return execute("execute", (t, a) -> t.execute((String) a[0]), new Object[] {sql});
    }

    @Override
    public ResultSet executeQuery(String sql) throws SQLException {
        return execute("executeQuery", (t, a) -> t.executeQuery((String) a[0]), new Object[] {sql});
    }

    @Override
    public int executeUpdate(String sql) throws SQLException {
        return execute("executeUpdate", (t, a) -> t.executeUpdate((String) a[0]), new Object[] {sql});
    }
