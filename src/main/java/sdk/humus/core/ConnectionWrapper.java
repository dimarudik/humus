...
public class ConnectionWrapper implements Connection {
    ...
    public Statement createStatement() throws SQLException {
        return execute(
                "createStatement",
                (conn, args) -> new StatementWrapper(conn.createStatement(), plugins, ""),
                new Object[0]);
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability)
        ...
        return execute(
                "createStatement",
                (conn, args) -> new StatementWrapper(
                        conn.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability), plugins, ""),
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        return execute(
                "prepareCall",
                (conn, args) -> new CallableStatementWrapper(conn.prepareCall(sql), plugins, sql),
                new Object[] {sql});
    }
    ...
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return execute(
                "prepareCall",
                (conn, args) -> new CallableStatementWrapper(
                        conn.prepareCall(sql, resultSetType, resultSetConcurrency), plugins, sql),
    ...
    public CallableStatement prepareCall(
        ...
        return execute(
                "prepareCall",
                (conn, args) -> new CallableStatementWrapper(
                        conn.prepareCall(sql, resultSetType, resultSetConcurrency, resultSetHoldability), plugins, sql),
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return execute(
                "prepareStatement",
                (conn, args) -> new PreparedStatementWrapper(conn.prepareStatement(sql), plugins, sql),
                new Object[] {sql});
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
        ...
        return execute(
                "prepareStatement",
                (conn, args) -> new PreparedStatementWrapper(
                        conn.prepareStatement(sql, resultSetType, resultSetConcurrency), plugins, ""),
                new Object[] {sql, resultSetType, resultSetConcurrency});
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return execute(
                "prepareStatement",
                (conn, args) ->
                        new PreparedStatementWrapper(conn.prepareStatement(sql, autoGeneratedKeys), plugins, sql),
    ...
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return execute(
                "prepareStatement",
                (conn, args) -> new PreparedStatementWrapper(conn.prepareStatement(sql, columnIndexes), plugins, sql),
    ...
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return execute(
                "prepareStatement",
                (conn, args) -> new PreparedStatementWrapper(conn.prepareStatement(sql, columnNames), plugins, sql),
