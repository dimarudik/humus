...
public class CallableStatementWrapper extends PreparedStatementWrapper implements CallableStatement {
    ...
    public CallableStatementWrapper(CallableStatement target, List<ProxyPlugin> plugins, String sql) {
        super(target, plugins, sql);
        this.target = target;
    }

    private <R> R execute(String methodName, JdbcCallable<CallableStatement, R> terminal, Object[] args)
            throws SQLException {
    ...
    public boolean execute() throws SQLException {
        return execute("execute", (CallableStatement t, Object[] a) -> t.execute(), new Object[] {this.sql});
    }

    @Override
    public ResultSet executeQuery() throws SQLException {
        return execute("executeQuery", (CallableStatement t, Object[] a) -> t.executeQuery(), new Object[] {this.sql});
    }

    @Override
    public int executeUpdate() throws SQLException {
        return execute(
                "executeUpdate", (CallableStatement t, Object[] a) -> t.executeUpdate(), new Object[] {this.sql});
    }
