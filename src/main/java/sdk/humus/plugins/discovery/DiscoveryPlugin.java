...
import static sdk.humus.plugins.discovery.DiscoveryConstants.CACHE_TTL_MS;
import static sdk.humus.plugins.discovery.DiscoveryConstants.PRIORITY;

public class DiscoveryPlugin implements ProxyPlugin {
    private static final Logger logger = Logger.getLogger(DiscoveryPlugin.class.getName());
    ...
    public DiscoveryPlugin(String discoveryAddr, String dbClusterName) {
    ...
    public String getTargetUrl(String url, Properties info) throws SQLException {
        ...
        return String.format("jdbc:postgresql://%s:%d/%s", node.getHost(), node.getPort(), dbName);
    }
